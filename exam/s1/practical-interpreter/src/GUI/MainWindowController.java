...
public class MainWindowController implements Initializable {
    ...
    @FXML
    private TableView<Map.Entry<Integer, MyITuple>> semaphoreTableView;
    @FXML
    private TableColumn<Map.Entry<Integer, Value>, Integer> semaphoreTableIndex;
    @FXML
    private TableColumn<Map.Entry<Integer, Value>, Integer> semaphoreTableValue;
    @FXML
    private TableColumn<Map.Entry<Integer, Value>, String> semaphoreTableValuesList;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        semaphoreTableIndex.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().getKey()).asObject());
        semaphoreTableValue.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().getKey()).asObject());
        semaphoreTableValuesList.setCellValueFactory(p -> new SimpleStringProperty(p.getValue().getValue() + " "));
    ...
    private void populateSemaphoreTableView(PrgState givenPrgState) throws MyException {
        semaphoreTableView.setItems(FXCollections.observableList(new ArrayList<>(givenPrgState.getSemaphoreTable().getSemaphoreTable().getContent().entrySet())));
